                    ...
                    <nav>
                        {/* <SignedIn> */}
                            <Link
                                prefetch={false}
                                href="/my-courses"
                                className='flex space-x-2 items-center text-sm font-medium text-muted-foreground hover:text-foreground 
                                transition-colors md:border-border md:rounded-md md:px-4 md:py-2'
                                >
